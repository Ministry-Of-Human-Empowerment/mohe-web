    ...
    <div className="flex flex-col min-h-screen bg-stone-900">
      ...
      <main className="flex-1">
        ...
        <section className="px-6 py-24 bg-stone-900 text-center">
          <p className="text-xs font-semibold tracking-widest uppercase text-amber-400 mb-4">Contact</p>
        ...
        <section className="px-6 py-20 bg-stone-950">
          <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
              <div className="border border-stone-700 rounded-2xl p-7 bg-stone-800">
              ...
              <div className="border border-stone-700 rounded-2xl p-7 bg-stone-800">
                <h3 className="font-semibold text-white mb-2">Membership</h3>
                <p className="text-sm text-stone-400 leading-relaxed mb-4">
            ...
            <div className="border border-stone-700 rounded-2xl p-8 bg-stone-800">
              ...
              <div className="space-y-4 opacity-40 pointer-events-none">
                <div>
                  <label className="block text-sm font-medium text-stone-300 mb-1.5">Your Name</label>
                  <div className="w-full border border-stone-600 rounded-lg px-4 py-2.5 bg-stone-700 text-sm text-stone-500">Full name</div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-stone-300 mb-1.5">Email</label>
                  <div className="w-full border border-stone-600 rounded-lg px-4 py-2.5 bg-stone-700 text-sm text-stone-500">your@email.com</div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-stone-300 mb-1.5">Message</label>
                  <div className="w-full border border-stone-600 rounded-lg px-4 py-2.5 bg-stone-700 text-sm text-stone-500 h-28">Your message...</div>
                </div>
                <div className="px-8 py-3 rounded-full bg-amber-500 text-stone-900 text-sm font-medium w-fit">
                  Send Message
                </div>
              </div>
            </div>
